...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    ImagenInfografica.color-acento-botones
      ...
      .tarjeta.color-primario.p-3(x="25%" y="30%" numero="2")
        p #[b Insumos o materias primas:] comprende todas esas mercancías adquiridas, ya sea de tipo natural tales como las verduras, frutas, agua, etc. o de componente artificial, siempre y cuando nos sirvan para transformar y crear un producto o servicio.

      .tarjeta.color-primario.p-3(x="55%" y="30%" numero="3")
        p #[b Abastecimiento interno:] cuando una empresa tiene la capacidad de elaborar un producto o servicio que sirva como materia prima para su producto principal es a lo que se le llama abastecimiento interno.
        ...
        .col-lg-7
          AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta acordeonA")
            ...
            .row(titulo="Eficiencia")
              .col-12
                p.mb-0 Cuando se realiza una buena gestión del abastecimiento se logra reducir muchos costos y recursos que son consecuencia de una correcta planificación y ejecución de los procesos.

            .row(titulo="Adaptabilidad")
              .col-12
                p.mb-0 Los cambios en los mercados se ven de manera constante, es ahí cuando todas las empresas deberán estar preparadas para estos movimientos bruscos de la economía, logrando ser ágiles y efectivos en la toma de decisiones para brindar una correcta respuesta a los inconvenientes y así poder continuar con las actividades diarias.
            ...
            .row(titulo="Comunicación")
              .col-12
                p.mb-0 Los líderes de cada uno de los departamentos implicados en el proceso de abastecimiento, deberá tener un contacto de manera continua con los demás, donde cada uno de ellos trabaje de manera transparente, compartiendo información relevante que sea de interés común, siempre teniendo como prioridad el correcto funcionamiento de la empresa.

            .row(titulo="Equilibrio")
              .col-12
