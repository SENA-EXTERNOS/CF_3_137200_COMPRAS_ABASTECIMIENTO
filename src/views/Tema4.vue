      ...
      .col-lg-9.banner-tema-3
        ...
        ul.lista-ul--color
          li 
            ...
            | Información general: allí deberán ir incluidos su nombre, características, componentes, código de barras, entre otros.

          li 
            i.fas.fa-angle-right
            | Categoría: en este ítem se deberá incluir la clasificación a la cual pertenece el producto o servicio.

          li 
            i.fas.fa-angle-right
            | Presentación: deberá ir incluido su peso, volumen, medidas, las unidades que vienen en una caja, etc.

          li 
            i.fas.fa-angle-right
            | Tipo de venta: número mínimo de venta, bonos por cantidad de compra.

        p #[b Ficha técnica de producción:]
        ...
        ul.lista-ul--color
          ...
          li 
            i.fas.fa-angle-right
            | Información para la fabricación del producto. 
    ...
    .row.justify-content-around.align-items-center.mt-5
      .col-lg-7
        ...
        .cajonAmarillo.bgr-tarjeta-tema1.p-4
            p La elaboración de una ficha técnica se basa en conocer de manera detallada el producto, saber todo el proceso que se llevó a cabo para la fabricación del mismo, cómo será su embalaje y distribución. Cuando se hace referencia al proceso de fabricación, se deben obtener datos de los componentes que fueron empleados, cantidades de cada materia prima, tipos de materias primas, procesos a los que fueron sometidas, tipos de empaque que se utilizaron, su material, etc. Su tipo de embalaje también es importante darlo a conocer (cartón, plástico, acetato). Y por último, conocer sus cantidades de distribución, si hay topes mínimos y máximos para su adquisición. Entonces se puede notar que la principal técnica para la elaboración de una ficha técnica es conocer absolutamente toda la información relacionada con el producto.
